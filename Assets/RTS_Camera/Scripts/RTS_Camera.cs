...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float followingSpeed = 2f; //speed when following a target
        ...
        public float minY = 0f; //z limit of map
        ...
        private TileOccupant targetFollow; //target to follow
        ...
        private void CameraUpdate()
        {
            ...
            if (targetFollow != null && targetFollow.Alive)
            {
                FollowTarget();
            }
        ...
        private void Move()
        {
            ...
            if (useKeyboardInput)
            {
                ...
                movement = movement || desiredMove != Vector3.zero;
        ...
        {
            Vector3 targetPos = new Vector3(targetFollow.Center.x, m_Transform.position.y, targetFollow.Center.z) + targetOffset;
        ...
        private void LimitPosition()
        {
            ...
            m_Transform.position = new Vector3(Mathf.Clamp(m_Transform.position.x, minX, maxX),
        ...
        public void SetTarget(TileOccupant target)
        {
            targetFollow = target;
        }
